...
//        Three cards data
        ...
        String todaysAppointmentCount = appointDoctorRepository.countAllByAppointmentDateAndPatientID(Date.valueOf(todayDate), principal.getName());
        String todaysCompletedAppointment = prescriptionRepository.countAllByAppointDoctorAppointmentDateAndMedicinesIsNotNullAndAppointDoctorPatientID(Date.valueOf(todayDate), user.getId() + "");
        ...
        String todaysGivenPrescriptions = prescriptionRepository.countAllByAppointDoctorAppointmentDateAndMedicinesIsNotNullAndAppointDoctorPatientID(Date.valueOf(todayDate), user.getId() + "");
