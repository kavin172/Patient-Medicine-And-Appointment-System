...
//    @Pattern(regexp = "\"^(?=.*[A-Za-z])(?=.*\\d)[A-Za-z\\d]{3,}$\"\n", message = "Password Should Be of Minimum eight characters, at least one letter and one number")
    ...
    public DoctorSignup(String s, String mail, String doctorpass123, String s1, String date, String number, String s2, String md, String cardiology, String harvard, double v) {
    }
