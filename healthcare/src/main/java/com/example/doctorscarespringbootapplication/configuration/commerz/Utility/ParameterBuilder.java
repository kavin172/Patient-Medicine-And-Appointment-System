...
public class ParameterBuilder {
    ...
    public static Map<String, String> constructRequestParameters() {
        ...
        String baseUrl = "https://ac2c-180-151-196-10.ngrok-free.app/";//Request.Url.Scheme + "://" + Request.Url.Authority + Request.ApplicationPath.TrimEnd('/') + "/";
        ...
        postData.put("ipn_url", "https://ac2c-180-151-196-10.ngrok-free.app/pay-success-validator");
        return postData;
    }
